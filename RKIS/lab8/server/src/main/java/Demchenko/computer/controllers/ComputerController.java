...
import Demchenko.computer.messaging.MessageProducer;
...
public class ComputerController {
    ...
    @Autowired
    public ComputerController(ComputerService computerService, MessageProducer messageProducer) {
    ...
    public String createComputer(@ModelAttribute("computers") @Valid Computer computer,
        ...
        if (bindingResult.hasErrors()) {
            model.addAttribute("currentPage", "new");
            messageProducer.sendMessage("An error with creating a new computer item");
            return "new";
        }
        computerService.saveComputer(computer);
        redirectAttributes.addFlashAttribute("message", "Computer successfully added.");
        messageProducer.sendMessage("Added an object: " + computer);
        return "redirect:/";
    }
    ...
    public String updateComputer(@ModelAttribute("computers") @Valid Computer computer,
        ...
        messageProducer.sendMessage("Updated an object: " + computer);
        return "redirect:/";
    }
    ...
    public String deleteComputer(@PathVariable("id") int id) {
        ...
        messageProducer.sendMessage("Deleted an object: " + computer);
        return "redirect:/";
    }
    ...
    public String buy(@PathVariable("id") int id) {
        ...
        if(computerService.doesNotExist(id)){
            ...
            try {
                computerService.buy(id);
                messageProducer.sendMessage("The product: " + computer + " was successfully purchased");
